...
if __name__ == '__main__':
    # draw_timing_grid(n_rows=6, t_end=50, x_label="Time (ns)")
    # signals_1 = {"A": [(0, 1), (5, 0)],
    #              "B": [(0, 1), (5, 1)],
    #              "C": [(0, 1), (5, 1)],
    #              "D": [(0, 1), (5, 0)],
    ...
    #              "E": [],
    #              "F": []}
    # draw_signals(signals=signals_1, x_label="Time (ps)",
    #              end_time=60,
    #              filename="hazard_1_graph.pdf")
    clk, period = [(0, 1)], 50
    for i in range(8):
        print(i)
        end_t = period*(i+1)
        clk.append((period*i+period//2, 0))
        clk.append((end_t, 1))
    print("clk", clk)
    print(len(clk))
    signals = {"CLK": clk,
               "X": [(0, 0), (55, 1), (105, 0),
                     (155, 1), (205, 0), (295, 1), (335, 0)],
               "X Bar": [],
               "A+": [],
               "A": [],
               "B+": [],
               "B": [],
               "Z": []}
    start_signals = {"A": (50, 1), "A+": (50, 1),
                     "B": (50, 0), "B+": (50, 0)}
    draw_signals(signals, end_time=len(clk)*period//2,
                 dt=period//2, minor_ticks=10,
                 start_signals=start_signals,
                 x_label="Time (ps)",
                 filename="Seq_detect_101.svg")
